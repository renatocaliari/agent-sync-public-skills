...
## Reactive Attributes (data-attrs-*)
...
<button
    ...
    data-attrs-disabled="$isSubmitting"
>
    Submit
</button>
```
...
### Always use retry in data-init

```html
<div
    data-init={ datastar.GetSSE("/api/data", {retryMaxCount: 3, retryInterval: 1000}) }
>
</div>
```
