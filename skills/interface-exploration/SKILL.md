...
description: Generate distinct UI/UX interface proposals for any conceptual product solution. Activate this skill automatically or when any of these signals appear: - Keywords / intents: "UI", "interface", "screen", "wireframe", "UX", "design alternatives", "explore visual", "trade-offs UI", "frontend options"
...
- After output, ask: "Select proposal? Refine? Integrate into plan?"
